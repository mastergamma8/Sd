...
ROULETTE_CONFIG = {
    ...
    "items": [
        ...
        {"type": "donuts", "amount": 10, "photo": "gifts/dount.png", "chance": 3},
        {"type": "donuts", "amount": 20, "photo": "gifts/dount.png", "chance": 1}, 
...
CASES_CONFIG = {
    ...
    2: {
        ...
        "items": [
            ...
            {"type": "donuts", "amount": 1, "chance": 7},                         
            {"type": "donuts", "amount": 5, "chance": 3},                         
            {"type": "donuts", "amount": 25, "chance": 1},
    ...
    3: {
        ...
        "items": [
            ...
            {"type": "donuts", "amount": 5, "chance": 10},                         
            {"type": "donuts", "amount": 10, "chance": 5},                         
            {"type": "donuts", "amount": 15, "chance": 4},
    ...
    4: {
        ...
        "items": [
            ...
            {"type": "donuts", "amount": 5, "chance": 37},                         
            {"type": "donuts", "amount": 10, "chance": 35},                         
            {"type": "donuts", "amount": 20, "chance": 30},
            {"type": "donuts", "amount": 28, "chance": 28},                         
    ...
    # ─────────────────────────────────────────────────────────────────────────
    {
        ...
        "items": [
            ...
            },
            {
                ...
                # пользователь получает сразу 25 звёзд + 1 пончика за 3 реферала
                "rewards": [
                ...
                "title": {"ru": "25⭐ + 1🍩", "en": "25 stars + 1🍩 per friend"},
                "enabled": True,
                "buy_limit": 1,
                "background": "gold",
                "expires_at": None,
