...
const i18n = {
     ru: {
            ...
            sub_required_desc: 'Чтобы крутить рулетку или открывать кейсы, подпишитесь на наш Telegram-канал',
        ...
        en: {
            ...
            sub_required_desc: 'To spin the wheel or open cases, subscribe to our Telegram channel',
